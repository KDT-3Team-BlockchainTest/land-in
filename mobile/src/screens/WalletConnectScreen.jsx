      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {!connected && (
          <View style={styles.noticeCard}>
            ...
            <Text style={styles.noticeStep}>1. MetaMask 앱을 설치하세요</Text>
            <Text style={styles.noticeStep}>2. 아래 버튼으로 MetaMask 앱을 여세요</Text>
            <Text style={styles.noticeStep}>3. MetaMask에서 Land-In 연결을 승인하세요</Text>
          </View>
        )}
